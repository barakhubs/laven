...
<div class="row">
	@if (in_array('dashboard.pending_loans_widget',$permissions))
	<div class="col-xl-3 col-md-6">
		<div class="card mb-4 primary-card dashboard-card">
			<div class="card-body">
				<div class="d-flex">
	...
	@if (in_array('dashboard.monthly_disbursed_widget',$permissions))
	<div class="col-xl-3 col-md-6">
		<div class="card mb-4 success-card dashboard-card">
			<div class="card-body">
				<div class="d-flex">
	...
	@if (in_array('dashboard.outstanding_portfolio_widget',$permissions))
	<div class="col-xl-3 col-md-6">
		<div class="card mb-4 warning-card dashboard-card">
			<div class="card-body">
				<div class="d-flex">
	...
	@if (in_array('dashboard.portfolio_at_risk_widget',$permissions))
	<div class="col-xl-3 col-md-6">
		<div class="card mb-4 danger-card dashboard-card">
			<div class="card-body">
				<div class="d-flex">
