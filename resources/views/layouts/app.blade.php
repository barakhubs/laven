...
<html lang="en">
    <head>
		...
		<link rel="stylesheet" href="{{ asset('backend/assets/css/styles.css') . '?v=' . filemtime(public_path('backend/assets/css/styles.css')) }}">
		<link rel="stylesheet" href="{{ asset('backend/assets/css/responsive.css?v=1.1') }}">
    ...
    <body>  
		...
		<div class="emergency-domain-banner">
			...
			{{ _lang('EMERGENCY LOANS SYSTEM') }} &mdash; {{ _lang('You are logged into the Emergency Loans domain') }}
		</div>
		@endif
		...
		<div class="page-container">
			...
			<div class="sidebar-menu">
				...
				<div class="sidebar-header text-center">
					<a href="{{ route('dashboard.index') }}"><img src="{{ get_logo() }}" class="company-logo" alt="logo"></a>			
				</div>
